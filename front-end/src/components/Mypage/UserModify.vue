      ...
      <b-col md="6" offset-md="3" class="mt-3 border rounded">
        <b-form class="p-3">
          <b-form-group
            ...
            label-for="input-1"
          >
            <b-form-input disabled id="input-1" v-model="user.id" type="text" required></b-form-input>
          </b-form-group>
          ...
          <b-form-group id="input-group-3" label-align="left" label-cols="2" label="이름 " label-for="input-3">
            <b-form-input id="input-3" v-model="user.name" type="text" placeholder="이름 입력" required></b-form-input>
          </b-form-group>

          <b-form-group id="input-group-4" label-align="left" label-cols="2" label="나이 " label-for="input-4">
            <b-form-input id="input-4" v-model="user.age" type="number" placeholder="나이 입력" required></b-form-input>
          </b-form-group>
